...
import { IconCheckEmpty, IconEmail, IconFace, IconInst, IconLink, IconLocation, IconStar, IconTwi } from "./IconsProfile";
    ...
    <div className="w-3/5 bg-gray-100 rounded-2xl shadow-lg bg-blend-darken">
      ...
      <div className="flex flex-col items-between justify-center w-fit">
          <div className="flex justify-center relative rounded-full overflow-hidden w-48 h-48 m-5 shadow-2xl">
            <img className="w-full h-full object-cover" src={image} alt="perfil"/>
      ...
      <div className="w-6/12 flex flex-col justify-center p-2">
        <div className="flex flex-col">
            ...
            <div className="flex justify-between items-center">
                ...
                <button className="bg-gray-900 text-white rounded-lg m-1 p-1 flex justify-stretch items-center shadow-lg"><IconEmail />Mensaje</button>
                <button className="bg-gray-900 text-white rounded-lg m-1 p-1 flex justify-stretch items-center shadow-lg"><IconEmail />Mensaje</button>
            </div>
        </div>
        ...
        <div className="flex justify-around w-full gap-x-px">
            <div className="bg-blue-200 rounded-tr-full rounded-tl-full rounded-bl-full p-1 m-3 flex justify-stretch items-center shadow-lg"><IconStar />AutoCad</div>
            <div className="bg-yellow-200 rounded-tr-full rounded-tl-full rounded-bl-full p-2 m-3 flex justify-stretch items-center shadow-lg"><IconStar />AutoCad</div>
            <div className="bg-gray-300 rounded-tr-full rounded-tl-full rounded-bl-full p-2  m-3 flex justify-stretch items-center shadow-lg"><IconStar />AutoCad</div>
        </div>
      </div>
      </div>
    </div>
