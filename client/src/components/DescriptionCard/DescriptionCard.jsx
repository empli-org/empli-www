    ...
    return (
        <div className="flex justify-between m-2 p-2 w-3/5">
            ...
            <div className="w-3/4 flex flex-col items-center">
                ...
                <button className='bg-gray-100 text-gray-700 font-medium py-2 px-4 border border-gray-300 rounded-full transition duration-500 ease-in-out hover:bg-gray-50 transform hover:-translate-y-1 hover:scale-100 shadow-lg'>Mostrar mas</button>
            </div>
        </div>
    ) 
}