        ...
        return (
          ...
          >
            ...
            <div className="p-4">
              ...
              <button className=" ml-28 mt-4 flex justify-center rounded bg-green-500 px-7 py-2 font-bold text-white hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400 active:bg-blue-600">
                Aplicar
              </button>
            </div>
          </div>
