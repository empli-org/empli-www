...
import { protectEmail } from '@/utils/tools'
...
export const CardProfile = ({ info }) => {
  ...
  return (
    <Container>
      <div className="w-full rounded-2xl bg-opacity-20 bg-login-img pt-4">
        <div className="rounded-2xl bg-gray-100 bg-blend-darken shadow-lg">
            ...
            <div className="flex w-9/12 flex-col justify-center p-2">
              <div className="flex flex-col">
                <div className="flex w-full justify-start gap-2">
                  ...
                  <VerifiedIcon verified={info.verified} />
                </div>
              ...
              <div className="flex w-full justify-center gap-3.5 p-2">
                <div className="flex w-6/12 flex-col items-center">
                  ...
                  <h1 className="text-xl font-bold">
                    {info.career ? info.career?.name : '-'}
                  </h1>
                </div>
                <div className="flex w-6/12 flex-col items-center">
                  <span>Experiencia</span>
                  <h1 className="text-xl font-bold">
                    {info.experienceInfo ? info.experienceInfo?.time : '-'}
                  </h1>
                </div>
                <div className="flex w-6/12 flex-col items-center">
                  <span>Usermail</span>
                  <h1 className="text-xl font-bold">
                    {protectEmail(info.userEmail)}
                  </h1>
                </div>
              </div>
